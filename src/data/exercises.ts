...
export const exercises: Exercise[] = [
  ...
  },
  {
    ...
    description: 'Keep hips stable against the pad, curl the weight toward you, and lower slowly.',
  },
  {
    id: 4,
    name: 'Hip Abduction Machine',
    muscleGroups: ['Gluteus Medius', 'Gluteus Minimus'],
    description: 'Sit upright, push knees outward under control, pause briefly, and return slowly.',
  },
  {
    id: 5,
    name: 'Hip Adduction Machine',
    muscleGroups: ['Adductors'],
    description: 'Sit upright, bring knees together in a controlled motion, then return slowly.',
  },
  {
    id: 6,
